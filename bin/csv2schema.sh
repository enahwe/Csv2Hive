...
CSV_SHORT_DIR=${WORK_DIR}
CSV_SHORT_FILE=${CSV_SHORT_DIR}/${CSV_SHORT_FILENAME}.${CSV_SHORT_EXTENSION}
...
VI_COMMANDS_EXTENSION="vi"
VI_COMMANDS_FILENAME=${CSV_FILENAME}
VI_COMMANDS_DIR=${WORK_DIR}
VI_COMMANDS_FILE=${VI_COMMANDS_DIR}/${VI_COMMANDS_FILENAME}.${VI_COMMANDS_EXTENSION}
